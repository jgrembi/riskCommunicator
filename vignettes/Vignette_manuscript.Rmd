---
title: "riskCommunicator package manuscript vignette"
...
output: 
  rmarkdown::html_vignette:
      ...
      toc: yes
vignette: >
  %\VignetteIndexEntry{riskCommunicator package vignette for manuscript}
...
The result obtained from the `gComp` function is an object of class **gComp** which is a list containing the summary results, `results.df`, `n`, `R`, `boot.result`, `contrast`, `family`, `formula`, `predicted.data`, and `glm.result` (see `?gComp` or `help(gComp)` for a more detailed explanation of each item in the list).  
