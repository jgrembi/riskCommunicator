...
All package documentation can be found by typing `?riskCommunicator` into the console. Documentation for individual functions can be found by typing `?` and then the function name (e.g. `?gComp` as shown above).  
## Preparing your data
