...
```{r continuousExposure_binaryOutcome, paged.print = FALSE}
set.seed(3728)
contExposure.formula <- cvd_dth ~ AGE + DIABETES + SEX + BMI + CURSMOKE + PREVHYP

(contExp.res <- pointEstimate(data = cvdd, formula = contExposure.formula, outcome.type = "binary", exposure.scaler = 10)$parameter.estimates)
