...
You can also obtain the sample estimated mean predicted values for each treatment/exposure group and subgroup, if applicable.
```{r, paged.print = FALSE}
binary.res$predicted.outcome
```
